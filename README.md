...
[`coldcuts`](https://github.com/kek/coldcuts) against the same
...
[`coldcuts`](https://github.com/kek/coldcuts) — but a bundle
...
| [`coldcuts`](https://github.com/kek/coldcuts) | Cross-builds the native apps — RetroArch and its cores, Moonlight — against the system’s own sysroot; publishes checksummed tarballs. |
